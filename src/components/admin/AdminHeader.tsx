...
const PAGE_TITLES: { prefix: string; title: string }[] = [
  ...
  { prefix: '/admin/stores', title: 'Кофейни' },
  { prefix: '/admin/analytics', title: 'Статистика' },
  { prefix: '/admin/loyalty/support', title: 'Обратная связь' },
  { prefix: '/admin/loyalty/menu', title: 'Контент меню' },
